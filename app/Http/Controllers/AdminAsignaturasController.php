<?php namespace App\Http\Controllers;
	...
	class AdminAsignaturasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"DOCENTE","name"=>"docente"];
			...
			$this->form[] = ['label'=>'DOCENTE','name'=>'docente','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Docente","name"=>"docente","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
